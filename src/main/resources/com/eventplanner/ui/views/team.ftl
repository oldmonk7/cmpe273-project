		...
		<div class="grid-container">
            ...
            <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                <header class="section-header">
                    ...
                    <p class="section-slogan">This project is a result of a collaborative efforts from all the team members to bring to you this service and make this idea work.</p>
                </header>
            </div>
